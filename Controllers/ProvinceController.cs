...
namespace Country.Controllers
{
    public class ProvinceController : Controller
    {
        ...
        public ProvinceController(CountryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Provinces != null ? 
                          ...
                          Problem("Entity set 'CountryContext.Provinces'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'CountryContext.Provinces'  is null.");
            }
            var province = await _context.Provinces.FindAsync(id);
            if (province != null)
            {
